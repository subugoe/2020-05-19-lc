...
address: "Big Blue Button"      # full street address of workshop (e.g., "Room A, 123 Forth Street, Blimingen, Euphoria")
country: "de"      # lowercase two-letter ISO country code such as "fr" (see https://en.wikipedia.org/wiki/ISO_3166-1#Current_codes)
language: "de, en"     # lowercase two-letter ISO language code such as "fr" (see https://en.wikipedia.org/wiki/List_of_ISO_639-1_codes)
...
humandate: "May 19, 20, 27, 2020; June 3 - 4, 2020 (preliminary)"    # human-readable dates for the workshop (e.g., "Feb 17-18, 2020")
humantime: "10:00 am - ca 13:20 pm; 14:00 pm - ca 16:20 pm (preliminary)"    # human-readable times for the workshop (e.g., "9:00 am - 4:30 pm")
...
{% endif %}
**Note:** the workshop consists of four independent lessons that can be taken separtely.
{% comment %}
AUDIENCE
...
<p id="where">
  ...
  {{page.address}}.
  <!-- Get directions with -->
  <a href="https://meet.gwdg.de/b/hva-ndx-gnh">BBB</a>
 <!-- or
...
https://pad.carpentries.org/2020-04-22-ugoe-carpentries
